...
class _ContractorProfileScreenState
  ...
  Future<void> userLogout() async {
    try {
      ...
      // ref.invalidate(housingDashBoardProvider);
      // ref.invalidate(housingIssueProvider);
      // ref.invalidate(jobProvider);
      // ref.invalidate(housingPropertyProvider);
                  ...
                  child: IconButtonWidget(
                    onTap: () {
                      AppRoutes.instance.push(
                        AppRoutesKey.instance.contractorEditProfileScreen,
                      );
                    },
                      ...
                      child: Column(
                        children: [
                          ...
                          ProfileButtonWidget(
                            ...
                            onTap: () {
                              AppRoutes.instance.pushNamed(
                                AppRoutesKey.instance.changePasswordScreen,
                              );
                            },
                          ),
                          ProfileButtonWidget(

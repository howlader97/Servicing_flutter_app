      ...
      return Dialog(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Gap(height: 10),
              AppText(text: content, textAlign: TextAlign.center,color: AppColors.instance.textHeading,),
              Gap(height: 20),
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: AppText(text: acceptButton,color: AppColors.instance.textHeading,),
                ),
              ),
              Gap(height: 10),
            ],

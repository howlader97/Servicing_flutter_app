...
class StorageServices {
  ...
  Future<String> getAppRoll() async {
    try {
      return await _secure.read(key: StorageKey.instance.appUserRollData) ?? 'HOUSING_MANAGER';
    } catch (e) {
  ...
  Future<void> setFcmToken(String value) async {
    final pref = await _pref;
    await pref.setString(StorageKey.instance.fcmToken, value);
  }

  Future<String> getFcmToken() async {
    try {
      final pref = await _pref;
      return pref.getString(StorageKey.instance.fcmToken) ?? "";
    } catch (e) {
